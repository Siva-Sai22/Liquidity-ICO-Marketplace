        ...
        >
            <div className="container" id="buyWoox">
                <div className="row bg-2">
                    <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 md30">
                        <header className="crumina-module crumina-heading heading--h2 heading-with-decoration">
                            ...
                            <div className="heading-text">
                                ...
                                adipisicing elit. Excepturi adipisci unde.
                            </div>
                        </header>

                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Expedita nemo perferendis reiciendis dicta,
                            quia tenetur praesentium quis eaque, eos nam
                            doloribus rerum ipsa facere natus quasi. Distinctio
                            enim earum voluptate?
                        </p>
                        ...
                        <div className="widget w-distribution-ends countdown-bg1">
                            ...
                            <div className="crumina-module crumina-skills-item skills-item-bordered">
                                ...
                                <span className="add-info">
                                    ...
                                    <span className="c-link-color">Eth</span>
                                </span>
                            </div>
